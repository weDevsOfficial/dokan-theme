	...
	<table cellpadding="0" cellspacing="0" class="woocommerce_variable_attributes wc-metabox-content">
		<tbody>
			<tr>
				<td class="sku" colspan="2">
					<?php if ( wc_product_sku_enabled() ) : ?>
						<label><?php _e( 'SKU', 'woocommerce' ); ?>: <a class="tips" title="<?php _e( 'Enter a SKU for this variation or leave blank to use the parent product SKU.', 'woocommerce' ); ?>" href="#">[?]</a></label>
				...
				<td class="data" rowspan="2">
					<table cellspacing="0" cellpadding="0" class="data_table">
						<?php if ( get_option( 'woocommerce_manage_stock' ) == 'yes' ) : ?>
							<tr>
								<td>
									<label><?php _e( 'Stock Qty:', 'woocommerce' ); ?> <a class="tips" title="<?php _e( 'Enter a quantity to enable stock management at variation level, or leave blank to use the parent product\'s options.', 'woocommerce' ); ?>" href="#">[?]</a></label>
							...
							<tr>
								<?php if ( wc_product_weight_enabled() ) : ?>
									<td class="hide_if_variation_virtual">
										<label><?php echo __( 'Weight', 'woocommerce' ) . ' (' . esc_html( get_option( 'woocommerce_weight_unit' ) ) . '):'; ?> <a class="tips" title="<?php _e( 'Enter a weight for this variation or leave blank to use the parent product weight.', 'woocommerce' ); ?>" href="#">[?]</a></label>
							...
							<td colspan="2">
								<div class="form-field downloadable_files">
									...
									<table class="widefat">
										<thead>
											<tr>
												<th><?php _e( 'Name', 'woocommerce' ); ?> <span class="tips" title="<?php _e( 'This is the name of the download shown to the customer.', 'woocommerce' ); ?>">[?]</span></th>
												<th colspan="2"><?php _e( 'File URL', 'woocommerce' ); ?> <span class="tips" title="<?php _e( 'This is the URL or absolute path to the file which customers will get access to.', 'woocommerce' ); ?>">[?]</span></th>
												<th>&nbsp;</th>
											</tr>
										</thead>
										<tfoot>
						...
						<tr class="show_if_variation_downloadable">
							<td>
								<div>
									<label><?php _e( 'Download Limit:', 'woocommerce' ); ?> <a class="tips" title="<?php _e( 'Leave blank for unlimited re-downloads.', 'woocommerce' ); ?>" href="#">[?]</a></label>
							...
							<td>
								<div>
									<label><?php _e( 'Download Expiry:', 'woocommerce' ); ?> <a class="tips" title="<?php _e( 'Enter the number of days before a download link expires, or leave blank.', 'woocommerce' ); ?>" href="#">[?]</a></label>
			...
			<tr>
				...
				<td class="options">
					<label class="checkbox"><input type="checkbox" class="checkbox" name="variable_enabled[<?php echo $loop; ?>]" <?php checked( $variation_post_status, 'publish' ); ?> /> <?php _e( 'Enabled', 'woocommerce' ); ?></label>

					<label class="checkbox"><input type="checkbox" class="checkbox variable_is_downloadable" name="variable_is_downloadable[<?php echo $loop; ?>]" <?php checked( isset( $_downloadable ) ? $_downloadable : '', 'yes' ); ?> /> <?php _e( 'Downloadable', 'woocommerce' ); ?> <a class="tips" title="<?php _e( 'Enable this option if access is given to a downloadable file upon purchase of a product', 'woocommerce' ); ?>" href="#">[?]</a></label>

					<label class="checkbox"><input type="checkbox" class="checkbox variable_is_virtual" name="variable_is_virtual[<?php echo $loop; ?>]" <?php checked( isset( $_virtual ) ? $_virtual : '', 'yes' ); ?> /> <?php _e( 'Virtual', 'woocommerce' ); ?> <a class="tips" title="<?php _e( 'Enable this option if a product is not shipped or there is no shipping cost', 'woocommerce' ); ?>" href="#">[?]</a></label>
