    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            foreach ($user_orders as $order) {
                ...
                <tr>
                    <td>
                        <?php echo '<a href="' . wp_nonce_url( add_query_arg( array( 'order_id' => $the_order->id ), get_permalink() ), 'dokan_view_order' ) . '"><strong>' . sprintf( __( 'Order %s', 'dokan' ), esc_attr( $the_order->get_order_number() ) ) . '</strong></a>'; ?>
                    </td>
                    <td>
                        <?php echo esc_html( strip_tags( $the_order->get_formatted_order_total() ) ); ?>
                    </td>
                    <td>
                        <?php printf( '<span class="label label-%s">%s</span>', dokan_get_order_status_class( $the_order->status ), esc_html__( $the_order->status, 'dokan' ) ); ?>
                    </td>
                    <td>
                        <?php
